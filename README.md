...
当前主线推进到 **Stage 5B：正演技术路线确立 + 正演主线重构 + 稳定算法入口硬化**。
...
Stage 5B 起，forward modeling 单独立为主线：
...
- F3 `elastic2d`：下一阶段 Rayleigh/free-surface/void scattering 的核心局部全波场方向。
...
- `elastic2d` 才是下一阶段 Rayleigh/free-surface/void scattering 的核心方向。
...
3. 按 `docs/elastic2d_forward_design.md` 进入局部 elastic2d 验证，但仍与主流程的运动学算法保持边界清晰。

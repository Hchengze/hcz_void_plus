...
- local background mean：`26.21`
- score contrast：`5.424`
- score percentile：`100.00%`
- multi-shot consistency mean：`111.1`
- multi-shot consistency std：`30.04`
...
- y span：`8.0` m
- depth span：`5.0` m
- equivalent uncertainty box：`{'x_min_m': 60.0, 'x_max_m': 60.0, 'y_min_m': 6.0, 'y_max_m': 14.0, 'depth_min_m': 0.5, 'depth_max_m': 5.5}`

## Stage 3B 新增 warning

- best depth 位于扫描边界：`False`
- best_x 高分区 y 跨度：`8.0` m

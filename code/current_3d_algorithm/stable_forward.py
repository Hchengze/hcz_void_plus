...
AVAILABLE_ELASTIC_VALIDATION_FORWARD = "elastic2d_prototype"
...
def get_stable_forward_summary() -> dict[str, object]:
    ...
    return {
        ...
        "available_elastic_validation_forward": AVAILABLE_ELASTIC_VALIDATION_FORWARD,
...
__all__ = [
    ...
    "AVAILABLE_ELASTIC_VALIDATION_FORWARD",

...
def test_scientific_figure_self_check_passes_consistent_stage5f_latest(tmp_path):
    ...
    assert result["checked_figure_count"] == len(RECOMMENDED_STAGE5F_FIGURES)

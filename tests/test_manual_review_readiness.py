...
def test_manual_review_readiness_passes_current_latest_stable():
    ...
    assert "figures/forward/fig_volume_wavefield_xyz_slices.png" in result["manual_review_figures"]
    assert "figures/localization/fig_3d_posterior_volume.png" in result["manual_review_figures"]
    assert "animations/forward/anim_single_shot_volume_wavefield.gif" in result["manual_review_animations"]
